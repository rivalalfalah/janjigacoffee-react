...
const Payment = () => {
  ...
  const handleTransactions = () => {
    if (product.id_product === null)
      return toast.error("you havent input order", {
      ...
      .post(
        `${process.env.REACT_APP_BACKEND_HOST}/transactions`,
        {
          ...
          total:
            ...
            (product.price * product.qty * 10) / 100 +
            (product.delivery_method === 1 ? 5000 : 0),
              ...
              >
                <div className={styles["box-left"]}>
                  ...
                  {product.id_product ? (
                    ...
                    >
                      <div>no cart yet, please choose product to checkout</div>
                    </div>
                  )}
                  ...
                  <div className={styles["total-payment"]}>
                    ...
                    <div className={styles["total-payment-right"]}>
                      ...
                      <p>
                        {product.delivery_method === 1
                          ? costing(5000)
                          : costing(0)}
                      </p>
                      <p>
                        {product.disc === null ? null : `${product.disc} %`}
                      </p>
                    </div>
                  </div>
